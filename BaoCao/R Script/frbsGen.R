...
## It can
varinp.mf
shape and parameters of membership functions of input variables.
see the fuzzifier function to construct the matrix.
be seen that in this case we employ TRAPEZOID as the membership functions.
<- matrix(c(2, 0, 20, 40, NA, 4, 20, 40, 60, 80, 3, 60, 80, 100, NA,
...
rule.and <- matrix(c("a1", "and", "b1", "and", "c1", "and", "d1", "->", "e1",
                     "a2", "and", "b2", "and", "c2", "and", "d2", "->", "e2",
                     "a3", "and", "b2", "and", "c2", "and", "d1", "->", "e3"),nrow = 3, byrow = TRUE)
...
rule <- matrix(
  c("v.1_a.2", "and",
    ...
    "v.1_a.2", "and",
    nrow = 3, byrow =
      on consequent parts we define categorical values instead of
    "v.2_a.2", "and", "v.3_a.3", "and", "v.4_a.2", "->", "3",
    "v.2_a.3", "and", "v.3_a.1", "and", "v.4_a.3", "->", "1",
    "v.2_a.2", "and", "v.3_a.2", "and", "v.4_a.2", "->", "2"),
  TRUE)
