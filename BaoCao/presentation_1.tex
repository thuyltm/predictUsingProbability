...
%----------------------------------------------------------------------------------------
\begin{frame}[t]{ Động lực giải bài toán}
Thực tế, các bác tài xế bắt buộc thời gian hoàn thành một chuyến đi trong thời hạn nhất định, nếu trễ giờ sẽ bị phạt.\\
Nếu có \textbf{\underline{nhu cầu}} dự đoán xác suất về trạm đúng giờ thì giải bài toán
\end{frame}

%----------------------------------------------------------------------------------------
\begin{frame}[t]{ Dữ liệu}

In the book "How to lie with Statistics", author Darrell Huff gives the reader five simple questions with which arm yourself against statistics\footnote{http://idiolect.org.uk/notes/?p=665}:
\begin{enumerate}
\item Who say so?
\item How does he know?
\item What's missing?
\item Did somebody change the subject?
\item Does it make sense?
\end{enumerate}
The originator of the data is from Smart BK Traffic of HCM University Of Technology, Vietnam
\end{frame}
...
\begin{enumerate}
\item Tác động của ngoại cảnh độc lập với các bước di chuyển trong 1 chuyến đi\\
$\rightarrow$ lấy ngẫu nhiên mẫu tháng 9, 10, 11
\item Các bước di chuyển độc lập lẫn nhau\\
$\rightarrow$ sử dụng Bayes cho các biến cố quan sát $X_1$, $X_2$, $X_3$, $X_4$, $X_5$ để dự đoán xác suất biến cố trong tương lai (đúng giờ hoặc trễ giờ) xảy ra
\end{enumerate}
...
\item \sout{Sử dụng kiến thức thống kê để kết quả tính toán từ mẫu ngẫu nhiên, giới hạn có thể ước lượng và xài được cho tổng thể với xác suất xảy ra cao} 
\end{enumerate}
\end{frame}
...
\end{itemize}
\underline{Kết luận} Xác suất phù hợp để dự đoán một biến cố xảy ra trên thực tế. Chấp nhận yếu tố ngẫu nhiên (yếu tố bên ngoài) tác động làm cho biến cố có xác suất xảy ra nhỏ nhất nhưng vẫn có thể xảy ra.\\
\end{frame}
...
Làm sao để \underline{kết quả thu được} (dự báo về trạm đúng giờ/trễ giờ) từ mẫu có thể có ý nghĩa được trên thực tế?\\
Áp dụng phương pháp thống kê
\begin{itemize}
\item Lấy mẫu như thế nào để là \underline{đại diện cho tổng thể} di chuyển từ BX Củ Chi đến BX An Sương\\ 
