...
Kham khảo \ref{DragAndDrop} tại mục Phụ Lục để lọc ra và kiểm tra dữ liệu đang khảo sát có phải là tuyến đi BX Củ Chi - BX An Sương không.\\ Sau đó kham khảo \ref{tinhkhoangcach} tại mục Phụ Lục để tính mỗi bước di chuyển. Sau đây là ví dụ 10 bước di chuyển đầu tiên trong moojy chuyến đi ngẫu nhiên được chọn\\
\begin{flushleft}
\begin{tabular}{|p{1cm}|p{1cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{1cm}|p{1cm}| }
\hline
Bước đầu & Bước kế tiếp & Vĩ độ đầu & Kinh độ đầu & Vĩ độ kế tiếp & Kinh độ kế tiếp & Khoảng cách (mét) & Thời gian di chuyển (seconds) \\ 
\hline
...
Cặp dòng sau đây có mối liên hệ với nhau, dòng trên chỉ khoảng thời gian hồi đáp, dòng dưới chỉ khoảng cách bước chuyển tương ứng với khoảng thời gian hồi đáp trên\\
17,20,20,20,20,09,01,20,20,20,05,12,20,20,14,20,02,20,20,20,21,05,20,07,20,15,10,\\
20,20,20,20,20,20,20,20,20,20,20,18,07,20,20,20,20,20,20,20,20,14,06,20,20,20,20,20,\\
13,20,15,12,04,20,20,20,20,11,05,20,20,20,20,20,20,20,20,20,20,20,20,11,06,20,06,07,\\
20,20,20,20,20,10,07,20,20,20,20,10,20,20,20,20,14,19,20,20,20,20,18,07,20,20\\
