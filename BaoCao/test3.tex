...
Có dữ liệu di chuyển 2/3 chặng đi từ bến xe An Sương đến bến xe Củ Chi của tuyến xe buýt 74 và kết quả tương ứng về trạm đích: đúng giờ hay trễ giờ. Sử dụng thao tác khai phá dữ liệu học có quan sát, phân chia dữ liệu thành 2 phần: phần để học có kèm theo kết quả về trạm đích, phần để kiểm tra đã loại bỏ kết quả về trạm đích. Dùng Toán thống kê vì ta chấp nhận giải trên dữ liệu có tính ngẫu nhiên do ta biết trên thực tế rất hiếm hai chuyến xe cùng lộ trình có những bước di chuyển cách nhau 30 giây giống nhau hoàn toàn, nó giống như câu ngạn ngữ "Không ai rửa chân hai lần trên cùng một dòng sông". Mục đích Luận Văn: dùng Toán thống kê mô hình dữ liệu học, dùng mô hình này để dán nhãn đúng giờ hay trễ giờ cho dữ liệu kiểm tra.\\
...
Kết quả của Luận Văn đóng góp cho nghiên cứu sau này:  
\section{Mục tiêu}
Luận Văn không đặt mục tiêu tham vọng giải bài toán này có thể đem ra ứng dụng thực tế được vì nhiều lý do sau đây:
\begin{itemize}
\item Kết quả của Luận Văn phụ thuộc nhiều và thay đổi theo nội dung và kích thước mẫu dữ liệu. Hiện tại Luận Văn đang cụ thể thao tác 351 mẫu ngẫu nhiên tháng 9 năm 2016 chuyến xe buýt của cùng tuyến 74. Muốn khắc phục được hạn chế này, phải có kiến thức thống kê vững chắc giúp ước lượng tổng thể từ mẫu với xác suất xảy ra cao hoặc phải làm việc trên dữ liệu siêu lớn. Cả hai điều này đều vượt quá giới hạn mục tiêu của Luận Văn này là tìm công cụ phù hợp để giải bài toán "Dự đoán xác suất xe về trạm đúng giờ" với dữ liệu nhỏ, nạp được vào bộ nhớ RAM khi đang thao tác. 
\item Ví dụ, với một mẫu dữ liệu kiểm tra, sau khi đi được 2/3 chặng, máy đưa ra xác suất xe về trạm đúng giờ là 98.5\%. Nhưng gặp sự cố tại 1/3 chặng đường cuối, tình trạng kẹt xe nặng, xe về trạm không đúng giờ như con số 98.5\% thông báo xe về trạm đúng giờ sau khi đi được 2/3 chặng. Các bác tài xế không thể điều khiển tình trạng xe chạy tại 1/3 chặng đường cuối. Vậy, con số 98.5\% thật sự có ý nghĩa sử dụng trên thực tế hay không? Câu trả lời đầu tiên, người đọc phải hiểu định nghĩa "xác suất". Xác suất để dự báo điều không chắc chắn xảy ra. Khi đã hiểu được bản chất định nghĩa "xác suất", người đọc có thể chấp nhận bài toán được giải trong Luận Văn này phần nào có ý nghĩa. 
\end{itemize}
Tóm lại, tác giả nhắc lại mục tiêu rất nhỏ và rất cụ thể của Luận Văn này: tìm được và chứng minh một cách giải hợp lý cho bài toán "Dự đoán xác suất thời gian về trạm đúng giờ" khi đi được 2/3 chặng đường.
...
\\Ví dụ, tập hợp tất cả các chuyến xe buýt từ Bến xe An Sương - Bến xe Củ Chi của tuyến 74 vào ngày 17 tháng 10 năm 2016 là một tổng thể hữu hạn và có thực.\\
Một ví dụ khác, tập tất cả các chuyến xe buýt từ Bến xe An Sương - Bến xe Củ Chi của tuyến 74 có thể về trạm trễ trong điều kiện: mưa nhiều, đường ngập, hẹp, rào chắn lô cốt, quá tải xe máy xuyên suốt cả ngày và va chạm xe máy thường xuyên. Tổng thể này là vô hạn và giả định.
...
Chẳng hạn, xét một mẫu 1000 dữ liệu các chuyến xe từ Bến xe An Sương - Bến xe Củ Chi của tuyến 74, luận văn này tìm ra được quy luật cảnh báo sớm tình trạng đến đích trễ cho các bác tài xế. Như ta đã biết trong nghiệp vụ, các bác tài xế phải hoàn thành mỗi chuyến đó trong một khoảng thời gian cho phép. Nhưng với điều kiện thực tế, sẽ có những chuyến hoàn thành sớm hơn hay trễ hơn so với thời gian quy định. \\
\end{itemize}
Chúng ta chỉ dự đoán được một phần trong nhiều hiện tượng mà ta gặp phải. Chẳng hạn, rất khó dự đoán chuyến xe đó có hoàn thành đúng thời gian về trạm đích hay không cho tất cả các tháng, các năm, các điều kiện khác nhau. Trong Luận Văn này, tôi tập trung vào đo lường xác suất xe về trạm trong một khoảng thời gian cụ thể, tháng 9 năm 2016, để dự đoán xe về trạm đúng giờ trong tương lai gần.\\
Ngoài ra, người đọc cần biết thêm, nếu lấy hết tất cả dữ liệu lịch sử các chuyến xe cụ thể đó (mặc dù nó hữu hạn và có thực), xem xét tất cả các chuyến xe trên mọi điều kiện không thể kiểm soát được trên thực tế để tìm quy luật cảnh báo sớm là quá tốn kém và không thực tế. Cho nên Luận Văn giới hạn giải trên mẫu, tháng 9 năm 2016, được coi là ngẫu nhiên, các yếu tố bên ngoài như thời gian, thời tiết, điều kiện mặt đường,... được coi là các yếu tố độc lập để giảm sự phức tạp giải bài toán, rút ra từ tổng thể.\\ 
Chú ý, trong Toán Thống Kê, tồn tại các phương pháp như phương pháp thí nghiệm thống kê, phương pháp lấy mẫu chấp nhận, phương pháp kiểm định giả thuyết,.. để từ mẫu ngẫu nhiên đủ rút ra đặc trưng của tổng thể với xác suất xảy ra cao. Nhưng để thực hiện được điều này, nó vượt quá kiến thức kỹ sư máy tính. Cho nên Luận Văn này không đặt tham vọng, giải trên mẫu có thể kết luận trên tổng thể với xác suất xảy ra cao.
...
\end{tabular}
\end{flushleft}
\item Source code R xuất hình thể hiện xác suất tích lũy thời gian hoàn thành BX Củ Chi - BX An Sương\\
\begin{flushleft}
\begin{tabular}{ |l| }
\hline
\textit{\#set your working directory where your file data locates}\\
...
\item Ứng dụng bản demo "Drag And Drop data layer GeoJSON" \footnote{https://developers.google.com/maps/documentation/javascript/examples/layer-data-dragndrop} của Google Map API để kiểm tra lộ trình\\
\FloatBarrier
\begin{figure}[h]
